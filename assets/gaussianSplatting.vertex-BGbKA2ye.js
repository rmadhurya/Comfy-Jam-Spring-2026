import{t as e}from"./shaderStore-D-XQlhUT.js";import{t}from"./sceneUboDeclaration-B96Tfx7b.js";import{t as n}from"./meshUboDeclaration-BATNZvmb.js";import{A as r,D as i,E as a,P as o,T as s,j as c,ot as l,w as u}from"./game-gq9wUXVS.js";var d=`gaussianSplattingVertexShader`,f=`#include<sceneUboDeclaration>
...
`;e.ShadersStoreWGSL[d]||(e.ShadersStoreWGSL[d]=f);var p=[t,n,o,c,i,a,l,r,s,u];for(let t of p)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var m={name:d,shader:f};export{m as gaussianSplattingVertexShaderWGSL};