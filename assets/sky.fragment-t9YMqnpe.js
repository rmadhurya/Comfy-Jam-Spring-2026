import{t as e}from"./shaderStore-D-XQlhUT.js";import{E as t,M as n,N as r,P as i,ct as a,lt as o,u as s,x as c}from"./game-AowfuWZe.js";var l=`skyPixelShader`,u=`varying vPositionW: vec3f;
#ifdef VERTEXCOLOR
...
`;e.ShadersStoreWGSL[l]||(e.ShadersStoreWGSL[l]=u);var d=[r,t,c,i,n,o,a,s];for(let t of d)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var f={name:l,shader:u};export{f as skyPixelShaderWGSL};