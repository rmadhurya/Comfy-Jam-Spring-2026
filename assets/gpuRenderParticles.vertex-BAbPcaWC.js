import{t as e}from"./shaderStore-D-XQlhUT.js";import{A as t,D as n,E as r,T as i,j as a,w as o}from"./game-gq9wUXVS.js";var s=`gpuRenderParticlesVertexShader`,c=`uniform view: mat4x4f;uniform projection: mat4x4f;uniform translationPivot: vec2f;uniform worldOffset: vec3f;
#ifdef LOCAL
...
`;e.ShadersStoreWGSL[s]||(e.ShadersStoreWGSL[s]=c);var l=[a,n,r,t,i,o];for(let t of l)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var u={name:s,shader:c};export{u as gpuRenderParticlesVertexShaderWGSL};